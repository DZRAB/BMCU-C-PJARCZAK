...
static const _tpu_param TPU_PARAMS[] =
{
    ...
    //   自吸(DM)仍用统一 DM_AUTO_PWM_PUSH_EMPTY=600, 不随型号/间歇变化。
    // 下列数值为初校值, 机台实测可再调。硬度升序: 85A(最软) < 90A < 95A < 68D(最硬)。
    ...
    { _tpu_model::TPU_FOR_AMS,  "GFU98", "TPU for AMS",  0x00u,0xFFu,0xFFu, 50.0f, 58.0f, 2000, 3000, 6000, 850.0f, 850.0f, 850.0f, 850.0f, 0.01f, 600, 500, 55.0f }, // 68D 青（最硬,近连续）
    { _tpu_model::TPU_95A_HF,   "GFU00", "TPU 95A HF",   0x00u,0xFFu,0x00u, 45.0f, 54.0f, 2500, 4000, 7000, 800.0f, 800.0f, 800.0f, 800.0f, 0.02f, 650, 450, 50.0f }, // 95A HF 绿
    { _tpu_model::TPU_GEN_AMS,  "GFU02", "Generic TPU",  0xFFu,0x00u,0xFFu, 50.0f, 58.0f, 2000, 3000, 6000, 850.0f, 850.0f, 850.0f, 850.0f, 0.01f, 600, 500, 55.0f }, // 约68D 紫（最硬,近连续）
    { _tpu_model::TPU_95A,      "GFU95", "TPU 95A",      0xFFu,0xD0u,0x00u, 45.0f, 54.0f, 2500, 4000, 7000, 800.0f, 800.0f, 800.0f, 800.0f, 0.02f, 700, 450, 50.0f }, // 95A 黄
    { _tpu_model::TPU_90A,      "GFU90", "TPU 90A",      0xFFu,0x80u,0x00u, 40.0f, 50.0f, 3000, 5000, 8000, 750.0f, 750.0f, 750.0f, 750.0f, 0.03f, 800, 420, 45.0f }, // 90A 橙
    { _tpu_model::TPU_85A,      "GFU85", "TPU 85A",      0xFFu,0x00u,0x00u, 35.0f, 46.0f, 3500, 6000, 9000, 700.0f, 700.0f, 700.0f, 700.0f, 0.04f, 900, 400, 40.0f }, // 85A 红（最软,停占比最高）
};
